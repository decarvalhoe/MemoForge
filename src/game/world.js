...
export const REGIONS = [
	...
	{ id: 'r3', name: 'Sortie & ASCII', addr: 'write · 0x0080', module: 'C00/C04', briques: ['B1', 'B3'], levelIds: [], unlock: 'r2' },
	{ id: 'r4', name: 'Chaînes & bornes', addr: "'\\0' · 0x00C0", module: 'C02/C03', briques: ['B2', 'B7'], levelIds: ['4-1'], unlock: 'r3' },
	{ id: 'r5', name: 'Conversion nombre↔texte', addr: '0x0100', module: 'C04', briques: ['B3', 'B4', 'B5'], levelIds: [], unlock: 'r4' },
	...
	{ id: 'r9', name: 'Listes & arbres', addr: '->next · 0x4000', module: 'C12/C13', briques: ['B10'], levelIds: [], unlock: 'r8' },
