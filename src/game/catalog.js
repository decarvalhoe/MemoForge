...
export const CATALOG = [
	...
	{ fn: 'ft_print_alphabet', module: 'C00', concept: 'boucle + write', tier: 'ready', deps: ['ft_putchar'], statut: 'jouable', level: 'io-2' },
	...
	{ fn: 'ft_putstr', module: 'C01', concept: 'parcourir jusqu\'au \\0', tier: 'ready', deps: ['ft_strlen'], statut: 'jouable', level: 'io-1' },
	...
	{ fn: 'ft_memset', module: 'libft-1', concept: 'remplir n octets', tier: 'octet', deps: [], statut: 'jouable', level: 'mem-2' },
	{ fn: 'ft_bzero', module: 'libft-1', concept: 'mettre à zéro', tier: 'octet', deps: ['ft_memset'], statut: 'a-forger', level: null, issue: '#105' },
	{ fn: 'ft_memcpy', module: 'libft-1', concept: 'copie n octets', tier: 'octet', deps: [], statut: 'jouable', level: 'mem-3' },
